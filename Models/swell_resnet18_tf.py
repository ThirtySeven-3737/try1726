...
class resnet18_tf(nn.Module):
    ...
    ##################################################################################################
def My_model(args):
    return  resnet18_tf(args.input_channels, args.num_classes, args.max_len, args.device)
